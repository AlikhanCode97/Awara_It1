...
using AwaraIT.BCS.Plugins.PluginExtensions.Attributes;
using AwaraIT.BCS.Plugins.PluginExtensions.Builder;
using AwaraIT.BCS.Plugins.PluginExtensions.Extensions;
...
namespace AwaraIT.BCS.Plugins.PluginExtensions
{
    public abstract class PluginBase : IPlugin
    {
        ...
        {
            if (!_configLoadError)
                return _config.GetValueOrDefault(parameterKey, defaultValue);
